...
Earlier versions of this repository published benchmark results that did not
hold up to review: the committed data was not generated by the committed code,
and the D* Lite implementation discarded its search state between replans. In
July 2026 those results were retracted and the project rebuilt: correct
D* Lite, tests that prove it, a fair benchmark, and numbers regenerated from
